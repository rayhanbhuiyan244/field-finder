...
const PRICING = [
  ...
  { label: "Peak Hour", window: "Daily, 7 PM - 10 PM",      price: 2000, note: "Premium slot",       order: 3 },
  { label: "Holiday",   window: "Public holidays",          price: 2200, note: "Holiday premium",    order: 4 },
  { label: "Early Bird", window: "Daily, 6 AM - 8 AM",      price: 1000, note: "Cheapest slot",     order: 5 },
  { label: "Tournament", window: "Full-day rentals",        price: 15000, note: "Team package",     order: 6 },
];

const REVIEWS = [
  { name: "Rakib Hasan",    initials: "RH", rating: 5, comment: "Top quality turf, floodlights are excellent for night matches. Booking took 20 seconds.", dateLabel: "2 days ago" },
  { name: "Nusrat Jahan",   initials: "NJ", rating: 5, comment: "Clean changing rooms and friendly staff. The pitch drains really well after rain.",        dateLabel: "1 week ago" },
  { name: "Tanvir Ahmed",   initials: "TA", rating: 4, comment: "Great value for money on weekday slots. Parking gets tight on Fridays.",                    dateLabel: "2 weeks ago" },
  { name: "Sadia Islam",    initials: "SI", rating: 5, comment: "Cafeteria is a nice touch. We come here every Friday now.",                                 dateLabel: "3 weeks ago" },
  { name: "Shakib Al Amin", initials: "SA", rating: 5, comment: "Best 5-a-side turf in the area. Surface feels premium under the studs.",                    dateLabel: "1 month ago" },
  { name: "Tasnim Akter",   initials: "TA", rating: 4, comment: "Booking system is smooth. Would love an app version too!",                                  dateLabel: "1 month ago" },
  { name: "Imran Hossain",  initials: "IH", rating: 5, comment: "We host our office 7-a-side league here every Wednesday. Never had a scheduling issue.",   dateLabel: "1 month ago" },
  { name: "Farhana Rahman", initials: "FR", rating: 4, comment: "Kids academy on Saturdays is well organised. Coaches are patient and skilled.",            dateLabel: "2 months ago" },
  { name: "Mahin Alam",     initials: "MA", rating: 5, comment: "Booked a birthday tournament — packages are transparent and the staff handled it end-to-end.", dateLabel: "2 months ago" },
];
