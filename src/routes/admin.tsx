...
type Section =
  "dashboard" | "bookings" | "calendar" | "customers" | "pricing" | "reports" | "settings";
    ...
    <>
      <div className="flex flex-wrap items-center justify-between gap-4">
        <div>
          ...
          <p className="text-sm text-muted-foreground">
            Google-Calendar-style view. Click any open cell to select.
          </p>
        </div>
            ...
            {slots.map((t) => (
              <tr key={t}>
                ...
                {days.map((d) => {
                  ...
                  const base: "available" | "booked" = bookedByDate[dateKey]?.has(t)
                    ? "booked"
                    : "available";
        ...
        <div className="rounded-2xl border border-border/60 bg-card p-6 shadow-sm">
          ...
          <div className="mt-4 space-y-3">
            ...
            <div className="space-y-2">
              ...
              <Input defaultValue="Free cancellation up to 6 hours before start." />
            </div>
          </div>
        </div>
