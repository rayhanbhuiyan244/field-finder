      ...
      <div className="mx-auto grid w-full max-w-7xl gap-10 px-6 py-14 md:grid-cols-4">
        ...
        <div>
          ...
          <ul className="mt-4 space-y-3 text-sm text-primary-foreground/80">
            <li className="flex items-start gap-2"><MapPin className="h-4 w-4 mt-0.5 shrink-0" /> {business.address}</li>
        ...
        <div>
          <h4 className="text-sm font-semibold uppercase tracking-wider text-primary-foreground/60">Opening Hours</h4>
          <p className="mt-4 text-sm text-primary-foreground/80">{business.hours}</p>
          <div className="mt-4 rounded-xl bg-white/5 p-4">
            <p className="text-xs uppercase tracking-wider text-primary-foreground/60">Owner Portal</p>
            <Link to="/admin" className="mt-1 inline-block text-sm font-semibold text-accent">Manage bookings →</Link>
          </div>
        </div>
      </div>
